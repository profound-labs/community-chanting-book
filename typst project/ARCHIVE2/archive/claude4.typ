...
#let page-number-display(page-num) = {
  ...
  place(
    ...
    dx: if calc.odd(page-num) { 0.7in } else { -0.7in },
    dy: -0.3in,
    text(
      font: "Ubuntu", 
      size: 12pt, 
...
#let full-image-page(image-path: "cover.png") = {
  page(
    margin: 0pt,
    numbering: none
  )[
...
#let table-of-contents() = {
  page(
    ...
    // Table of contents entries matching your image
    #part-header("1", "Morning Chanting", "1")
    
    #toc-entry("Dedication of Offerings", "2")
    #toc-entry("Preliminary Homage", "3")
    #toc-entry("Homage to the Buddha", "4")
    #toc-entry("Homage to the Dhamma", "6")
    #toc-entry("Homage to the Saṅgha", "7")
    #toc-entry("Salutation to the Triple Gem", "9")
    #toc-entry("Closing Homage", "16")
    
    #part-header("2", "Evening Chanting", "17")
    
    #toc-entry("Dedication of Offerings", "18 / 19")
    #toc-entry("Preliminary Homage", "20 / 21")
    #toc-entry("Recollection of the Buddha", "20 / 21")
    #toc-entry("Supreme Praise of the Buddha", "22 / 23")
    #toc-entry("Recollection of the Dhamma", "24 / 25")
  ]
}
...
#full-image-page(image-path: "cover.png")
