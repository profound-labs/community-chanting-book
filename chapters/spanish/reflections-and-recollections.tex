...
\begin{leader}
  [Cantemos ahora los versos de compartir y aspiración.]
\end{leader}
...
\begin{english}
	...
	de las buenas acciones que he hecho:
\end{english}
...
\begin{english}
	...
	De tres planos y cuatro tipos de nacimiento,\\
	Con cinco agregados o uno o cuatro,\\
	Vagando de nacimiento en nacimiento,
\end{english}
...
\begin{english}
	Aquellos que conocen mi acto de dedicación,\\
...
[Yo viviré permeando] un cuadrante del mundo\\
...
Yo viviré permeando el mundo completo\\
\vin con un corazón saturado de metta; abundante, exaltado,\\
\vin inmensurable, sin hostilidad y sin mala-fe.
...
inmensurable, sin hostilidad y sin mala-fe.
...
[Yo viviré permeando] un cuadrante del mundo\\
\vin con un corazón saturado de ecuanimidad; de igual forma\\
\vin el segundo, de igual forma el tercero, de igual forma el cuarto;\\
Tanto hacia arriba, como hacia abajo, alrededor y en todas direcciones;\\
\vin y para todos, tanto como para mí.\\
Yo viviré permeando el mundo completo\\
\vin con un corazón saturado de ecuanimidad; abundante, exaltado,\\
\vin inmensurable, sin hostilidad y sin mala-fe.

\chapter{Las Sumas Bendiciones}
...
Así que, cuáles son las sumas Bendiciones?'

`Evitar a los idiotas,\\
Asociarse con los Sabios,\\
Y honrar lo que es digno de ser honrado.\\
Estas son las sumas bendiciones.

`Vivir en sitios adecuados,\\
...
Oír el Dhamma propiamente enseñado.\\
Estas son las sumas bendiciones.
...
Conocen la Victoria donde quiera que van,\\
...
\begin{english}
  Monjes, existen diez dhammas \pause\ sobre los cuales se debe reflexionar frecuentemente. \pause\ Cuales son estos diez dhammas?
\end{english}
...
\begin{english}
  ...
  Aquel que es renunciante \pause\ debe reflexionar sobre esto frecuentemente.
\end{english}

Parapaṭi꜕baddhā me jīvi꜓kā'ti pabba꜕jitena a꜕bhiṇhaṁ pacca꜕vekkhi꜓tabbaṁ

\begin{english}
  `Mi propia vida es sostenida \pause\ por la generosidad de otros.' \pause\\
  Aquel que es renunciante \pause\ debe reflexionar sobre esto frecuentemente.
\end{english}
...
\begin{english}
  Monjes estos son los diez Dhammas \pause\ sobre los cuales se debe reflexionar preferentemente.
\end{english}
