...
\begin{twochants}
	\includegraphics[scale=0.25]{anjali_man.png} & \includegraphics[scale=0.25]{anjali_woman.png}
\end{twochants}	
...
\begin{figure}[h]
	...
	\begin{minipage}{0.49\textwidth}
		\centering
		\includegraphics[scale=0.25,width=1\textwidth]{abhivad_man.png}
	...
	\begin{minipage}{0.49\textwidth}
		\centering
		\includegraphics[scale=0.25,width=1\textwidth]{abhivad_woman.png}
