...
\flushleft{
\includegraphics[scale=0.25]{anjali_man.png}
}
\flushright{
	\includegraphics[scale=0.25]{anjali_woman.png}
}
...
\flushleft{
	...
	\includegraphics[scale=0.25]{vandami_man.png}
}
\flushright{
	Las mujeres inclinan la cabeza ligeramente hacia adelante.
	\includegraphics[scale=0.25]{vandami_woman.png}
}
...
\flushleft{
	Los hombres mantienen los codos y las rodillas alineados y tocándose.
	\includegraphics[scale=0.25]{abhivad_man.png}
}
\flushright{
	Las mujeres colocan los codos a cada lado de las rodillas
	\includegraphics[scale=0.25]{abhivad_woman.png}
}
...
\flushleft{
	Los hombres se sientan con una pierna doblada a un lado y la otra pierna cruzada frente a ellos, con la planta del pie tocando la rodilla.
	\includegraphics[scale=0.25]{papiyap_man.png}
}
\flushright{
	Las mujeres se sientan con una pierna doblada a un lado, pero con la otra pierna doblada debajo de ellas, manteniendo las rodillas juntas. Tradicionalmente, las mujeres no se sientan con las rodillas muy separadas mientras cantan como lo hacen los hombres.
	\includegraphics[scale=0.25]{papiyap_woman.png}
}
