...
\begin{english}
  ...
  Resultando em quê como essência, são todas as coisas?\\
  Fundindo-se em quê, são todas as coisas?\\
  Terminando em quê, são todas as coisas?

  \bigskip

  Amigo, todas as coisas são enraizadas no desejo.\\
  Todas as coisas nascem da atenção.\\
  Todas as coisas provêm do contato.\\
...
\begin{english}
  com o seu corpo erecto, e estabelece sati à sua frente.
\end{english}

So sa꜕to'va a꜕ssasa꜕ti sa꜕to'va pa꜕ssa꜕sa꜕ti

\begin{english}
  Ciente, ele inspira; ciente, ele expira.
\end{english}
...
\begin{english}
  ...
  Abutres. Ali, ele dirigiu-se aos monges: `Monges, eu irei ensinar-lhe as sete
...
\begin{english}
  ...
  harmonia e levarem a cabo os assuntos da Saṅgha em harmonia, o seu crescimento
...
\begin{english}
  `Enquanto os monges não decretarem o que não foi decretado nem revogarem o que
...
\begin{english}
  `Enquanto os monges virem o seu próprio benefício nas habitações das
  florestas, o seu crescimento pode ser esperado, não o seu declínio.'
\end{english}
...
\begin{english}
  `Enquanto cada um dos monges mantiver firmemente em mente: ``Se houverem
