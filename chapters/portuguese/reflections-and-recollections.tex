...
\begin{english}
  ...
  um corpo’ é nele estabelecida ao ponto de haver conhecimento directo e consciência inabalável.

  \bigskip

  E ele vive de forma independente, sem se apegar a nada no mundo. Bhikkhus, 
  é desta forma que, considerando o corpo, um bhikkhu mantém-se a contemplar o corpo.
\end{english}
