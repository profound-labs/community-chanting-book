...
\begin{english}
  Monges, \pause\ estes onze benefícios podem ser esperados \pause\ como resultado da libertação do coração \pause\ pela prática da bondade amorosa, conhecendo-a, cultivando-a, desenvolvendo-a, tendo-a como meio de expressão, estimando-a, seguindo-a, empreendendo-a \pause\ e estabelecendo-a.
\end{english}
