...
\begin{english}
  Monges, \pause\ há onze benefícios que podem ser esperados \pause\ como resultado da libertação do coração \pause\ pela prática da bondade amorosa, conhecendo-a, cultivando-a, desenvolvendo-a, tendo-a como guia, estimando-a, seguindo-a, consolidando-a e implementando-a.\\
  Quais são os onze?
\end{english}
...
\begin{english}
  Monges, \pause\ estes onze benefícios podem ser esperados \pause\ como resultado da libertação do coração \pause\ pela prática da bondade amorosa, conhecendo-a, cultivando-a, desenvolvendo-a, tendo-a como meio de expressão, estimando-a, seguindo-a, empreendendo-a e estabelecendo-a.
\end{english}
