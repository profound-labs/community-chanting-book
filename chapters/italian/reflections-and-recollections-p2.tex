...
\begin{english}
Sono questi rimedi curativi e così la persona che li consuma
\end{english}
...
\begin{english}
Tutte formazioni sono impermanenti;
\end{english}
...
\begin{english}
In verità tutte le cose condizionate non possono durare,
\end{english}
...
\begin{english}
Il loro estinguersi è vera felicità.
\end{english}
...
\begin{english}
  [Cantiamo ora i versi sui veri e falsi rifugi]
\end{english}
...
\begin{english}
Molti uomini vanno in cerca di rifugio spinti dalla paura.\\
nei monti, nelle foreste,\\
nei parchi e sotto gli alberi sacri,
\end{english}
...
\begin{english}
  ...
  un tale rifugio porta davvero\\
  alla completa liberazione da ogni sofferenza.
\end{english}
...
\begin{english}
  ...
  la cui virtù è pura e amata dai Nobili;,
...
\begin{english}
  ...
  che vede le cose chiaramente come sono,\\
  si dice che la sua vita\\
  non è invana.
\end{english}
...
\begin{english}
  ...
  alla fiducia di vedere il Dhamma,\\
  a questo i si dedicano i saggi,\\
  l'insegnamento del Buddha è nella loro mente.
\end{english}
...
\begin{english}
  ...
  ci si stanca di ogni sofferenza;\\
...
\begin{english}
  ‘Insoddisfacenti sono tutte le cose condizionate’ –\\
  quando con saggezza questo si vede\\
  ci si stanca di ogni sofferenza;\\
  questo è il sentiero della purificazione.
\end{english}
...
\begin{english}
  ...
  il regno della morte così difficile da attraversare.
\end{english}
...
\begin{english}
  ...
  dalle inondazioni raggiungono la terra asiutta,\\
  vivendo ritirati, che è cosa così difficile da fare.\\
  Una tale rara delizia si dovrebbe desiderare,\\
  i piaceri dei sensi abbandonati,\\
  senza possedimenti.
\end{english}
