...
\begin{english}
Al Dhamma, che ha cosi ben esposto
\end{english}
...
\begin{english}
al Buddha, al Dhamma e al Saṅgha
\end{english}
...
\begin{english}
Questi umili doni e onori siano accolti
\end{english}
...
\begin{english}
  Omaggio al Beato, al Nobile e Perfettamente Risvegliato.
...
\begin{english}
  In questo mondo con i suoi déi, demoni e Brahma, 
\end{english}

Sassa꜓maṇa-brāhmaṇiṁ pa꜕jaṁ sa꜕deva-ma꜕nussa꜓ṁ sa꜕yaṁ a꜕bhiññā sacchika꜕tv꜓ā pa꜕vedesi

\begin{english}
  popoli e guide, ricercatori e saggi, lui ha \\rivelato la Verità con profonda comprensione.
\end{english}
