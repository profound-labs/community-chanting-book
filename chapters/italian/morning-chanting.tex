...
Buddhaṃ bh\cD{a}gavantaṃ \cD{a}bh\cU{i}vādemi \instr{Inchino}
...
S\cU{a}ṅghaṃ n\cD{a}māmi \instr{Inchino}
...
s\cD{i}ras\cU{ā} n\cD{a}māmi \instr{Inchino}
...
\vin tam-ah\cU{a}ṃ dhammaṃ s\cD{i}ras\cU{ā} n\cD{a}māmi \instr{Inchino}
...
\vin tam-ah\cU{a}ṃ saṅghaṃ s\cD{i}ras\cU{ā} n\cD{a}māmi \instr{Inchino}

\chapter{Saluti alla Triplice Gemma}% {{{1
