...
\chapter[Dieci temi]{Dieci temi su cui un rinunciante dovrebbe riflettere spesso}
...
\begin{english}
  [Cantiamo ora i dieci temi su cui un rinunciante dovrebbe riflettere spesso]
\end{english}
...
\begin{english}
 Non vivo più seguendo valori e scopi mondani.
 Questo è ciò su cui dovrebbe riflettere spesso un rinunciante.
\end{english}

Parapaṭi꜕baddhā me jīvi꜓kā'ti pabba꜕jitena a꜕bhiṇhaṁ pacca꜕vekkhi꜓tabbaṁ

\begin{english}
 La mia vita è sostenuta attraverso i doni degli altri.
Questo è ciò su cui dovrebbe riflettere spesso un rinunciante.
\end{english}
...
Sento del rimorso pensando alla mia condotta?
Questo è ciò su cui dovrebbe riflettere spesso un rinunciante.
...
\begin{english}
I miei compagni spirituali sono forse scontenti della mia condotta?
Questo è ciò su cui dovrebbe riflettere spesso un rinunciante.
\end{english}
...
\begin{english}
Sono padrone del mio kamma, erede del mio kamma, nato dal mio kamma, legato al mio kamma;
 qualunque kamma compio, buono o cattivo ne sarò l'erede.
 Questo è ciò su cui dovrebbe riflettere spesso un rinunciante.
\end{english}
...
\begin{english}
 I giorni e le notti stanno passando inesorabilmente; come sto spendendo il mio tempo?
 Questo è ciò su cui dovrebbe riflettere spesso un rinunciante.
\end{english}
...
\begin{english}
La mia pratica sta dando frutti di libertà e di intuizione?
 Così che alla fine della mia vita non debba sentirmi imbarazzato
  quando sarò interrogato dai miei compagni spirituali.
\end{english}

Ime kho bhikkha꜓ve da꜕sa꜕ dhammā pabba꜕jitena a꜕bhiṇhaṁ pacca꜕vekkhitabbā'ti

\begin{english}
Bhikkhu, questi sono i dieci temi su cui dovrebbe riflettere spesso un rinunciante.
\end{english}

\chapter[Le 32 parti]{Riflessione sulle 32 parti del corpo}
...
\begin{english}
[Questo mio corpo] dalla punta dei piedi alla sommità del capo\\
 è una sacca di pelle piena di cose sporche,
\end{english}
...
nahārū          & \tr{tendini} \\
aṭṭhī           & \tr{ossa} \\
aṭṭhimiñjaṁ     & \tr{midollo osseo} \\
vakkaṁ          & \tr{reni} \\
hadayaṁ         & \tr{cuore} \\
yakanaṁ         & \tr{fegato} \\
kilomakaṁ       & \tr{membrane} \\
pihakaṁ         & \tr{milza} \\
papphāsaṁ       & \tr{polmoni} \\
\end{tabular}
...
\begin{tabular}{ r l }
antaṁ           & \tr{budella} \\
antaguṇaṁ       & \tr{mesentere} \\
udariyaṁ        & \tr{cibo non digerito} \\
karīsaṁ         & \tr{escrementi} \\
pittaṁ          & \tr{bile} \\
semhaṁ          & \tr{catarro} \\
pubbo           & \tr{pus} \\
lohitaṁ         & \tr{sangue} \\
sedo            & \tr{sudore} \\
medo            & \tr{grasso solido} \\
assu            & \tr{lacrime} \\
vasā            & \tr{grasso fluido} \\
kheḷo           & \tr{saliva} \\
siṅghāṇikā      & \tr{muco} \\
lasikā          & \tr{liquido sinoviale} \\
muttaṁ          & \tr{urina} \\
matthaluṅgan'ti & \tr{cervello} \\
\end{tabular}
...
\begin{english}
Così, questo mio corpo, dalla punta dei piedi alla sommità del capo
è una sacca di pelle piena di cose sporche. 
\end{english}
